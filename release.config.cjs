...
const repo = "my-first-npm-package";
...
- GitHub npm Package: [\${nextRelease.version}](https://github.com/${owner}/${repo}/pkgs/npm/${repo})
- npm Package: [\${nextRelease.version}](https://www.npmjs.com/package/${npmScope}/${repo}/v/\${nextRelease.version})
